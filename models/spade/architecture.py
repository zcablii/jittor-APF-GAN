...
from models.spade.normalization import SPADE
...
class SPADEResnetBlock(nn.Module):
    def __init__(self, fin, fout, opt):
        ...
        self.norm_0 = SPADE(spade_config_str, fin, opt.semantic_nc, opt=opt)
        self.norm_1 = SPADE(spade_config_str, fmiddle, opt.semantic_nc, opt=opt)
        if self.learned_shortcut:
            self.norm_s = SPADE(spade_config_str, fin, opt.semantic_nc, opt=opt)
