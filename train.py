...
#--- create optimizers ---#
if opt.distributed:
    opt.lr_g = opt.lr_g / 32 * opt.batch_size
    opt.lr_d = opt.lr_d / 32 * opt.batch_size
print(f'Effective G learning rate={opt.lr_g}, Effective D learning rate={opt.lr_d}')
...
for epoch in range(start_epoch, opt.num_epochs):
    ...
    for i, data_i in enumerate(tqdm(dataloader, ncols=100)):
